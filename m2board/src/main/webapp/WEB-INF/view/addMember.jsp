...
<body>
   ...
   <form action="addMember" method="post">
	...
	<tr>	
      ...
      <tr>
      <td> 주소입력 </td>
      <td><input type="text" name="addr" id="addr" readonly="readonly">
     ...
     <tr>	
		<td>전화번호</td>
		<td><input type="text" name="memberTelephone" id= "memberTelephone"></td>
	</tr> 
   ...
   <a href="${pageContext.request.contextPath}/login">뒤로가기</a>
